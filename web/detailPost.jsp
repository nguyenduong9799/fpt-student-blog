            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container-fluid px-4">
                    ...
                    <form action="MainController">
                        <h2 class="mt-4"><%=post.getTitle()%></h2>
                        <h4>Author: <%=post.getUserID()%></h4>
                        <h4>Category: <%=post.getCategory()%></h4>
                        <h4>Status: <%=post.getStatus()%></h4>
                        <h4>Tags:</h4>
                        <%
                        ...
                        %>
                        <br>
                        <h4>Create date: <%=post.getDate()%></h4>
                        ...
                        <input class="btn btn-primary" type="submit" name="action" value="Approve">
                        <input class="btn btn-primary" type="submit" name="action" value="Deny">
                        <%
                        } else {
                        %>
