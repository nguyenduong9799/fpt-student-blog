 ...
 * @author buili
 */
@WebServlet(name = "CreateMentorController", urlPatterns = {"/CreateMentorController"})
public class CreateMentorController extends HttpServlet {

    private static final String ERROR = "createMentor.jsp";
    private static final String SUCCESS = "listMentor.jsp";
