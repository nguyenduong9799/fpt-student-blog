 ...
 * @author ACER
 */
@WebServlet(name = "SubmitAgainController", urlPatterns = {"/SubmitAgainController"})
public class SubmitAgainController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            PostDTO post = new PostDTO(postID, userID, status, category, title, postContent, date, 0, approveComment, image);
            PostDAO dao = new PostDAO();
            boolean check = dao.updatePost(post);
            if (check) {
